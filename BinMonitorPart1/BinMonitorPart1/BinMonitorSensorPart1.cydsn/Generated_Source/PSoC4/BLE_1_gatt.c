    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'B', (uint8)'L', (uint8)'E', (uint8)'_', (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o',
    (uint8)'r',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Temperature Data */
    { 0xB0u, 0xB4u, 0xBCu, 0x9Du, 0x7Du, 0x04u, 0xB7u, 0xB2u, 0x8Bu, 0x41u, 0x37u, 0xB3u, 0x06u, 0x37u, 0x89u, 0x19u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Temperature Data UUID */
    { 0x0001u, (void *)&cyBle_attValues[26] }, /* Temperature Data */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x12u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0012u, {{0xBFF2u, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x3706u /* Temperature Data                    */, 0x090A0101u /* rd,wr */, 0x0012u, {{0x0001u, (void *)&cyBle_attValuesLen[8]}} },
};
