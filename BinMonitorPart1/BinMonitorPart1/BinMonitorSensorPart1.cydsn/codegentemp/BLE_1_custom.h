...
#define CYBLE_TEMPERATURE_SERVICE_TEMPERATURE_DATA_CHAR_INDEX   (0x00u) /* Index of Temperature Data characteristic */


#define CYBLE_TEMPERATURE_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of Temperature Service service */
#define CYBLE_TEMPERATURE_SERVICE_TEMPERATURE_DATA_DECL_HANDLE   (0x0011u) /* Handle of Temperature Data characteristic declaration */
#define CYBLE_TEMPERATURE_SERVICE_TEMPERATURE_DATA_CHAR_HANDLE   (0x0012u) /* Handle of Temperature Data characteristic */
